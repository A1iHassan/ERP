...
const AuthPage = () => {
	...
	return (
		...
		<Form className="flex flex-col justify-center items-center gap-4 border border-slate-50 shadow-lg p-16 rounded-2xl min-w-1/4">
		  ...
		  <input type="text" className="hidden" value={state}/>
